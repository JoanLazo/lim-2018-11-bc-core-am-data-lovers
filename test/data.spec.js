...
const input = [
...

  {
    ...
    blurb: 'Go ahead, run. Ill give you a five minute head start.<br><br>One of the reasons Piltover is known as the City of Progress is because it has an extraordinarily low crime rate. This hasnt always been the case; brigands and thieves of all sorts ...',
...

  {
    ...
    blurb: 'There is no greater symbol of Noxian might than Darius, the nations most feared and battle-hardened warrior. Orphaned at a young age, Darius had to fight to keep himself and his younger brother alive. By the time he joined the military, he had ...',
